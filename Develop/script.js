...
// if valid, add length to passwordArray

// when length is valid, move to next prompt

// prompt for lowercase
// take user input and store in variable, if yes, add lowercase to passwordArray
...
// take user input and store in variable, if yes, add uppercase to passwordArray
// uppercase characters are 65-90

// when yes / no is selected, move to next prompt

// prompt for numeric
// take user input and store in variable, if yes, add numeric to passwordArray
// numeric characters are 48-57

// when yes / no is selected, move to next prompt

// prompt for special characters
// take user input and store in variable, if yes, add special characters to passwordArray
